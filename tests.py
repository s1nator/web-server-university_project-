...
def send_msg():
    ...
    response = requests.get('https://127.0.0.1:4747//Users/denisbrevnov/Documents/Files/code/Python/Python_FIIT/Python_TASK/web_server_repo/web-server-university_project-/folderserver/folderserver.htm', verify=False)
    return response
...
class Tests(unittest.TestCase):
    ...
    def test_write_into_access_log(self):
        ...
        with open("access.log", "r") as f:
            lines = f.readlines()
        self.assertEqual(lines[-1].split("|")[3],"('200 OK', 'User-Agent: python-requests/2.32.4')")
